...
public class MultipleRoom_ElitePackage_Test extends RunnerTest{

     /*UX_5,TC_2*/
	
	@Test
	public synchronized void multipleRoomsWithElitePackage(){
		Log.startTestCase("MultipleRoom_ElitePackage_Test");
		...
		if(ImageUtils.countBrokenImages("font-size", "14px")==0) {
			...
			Log.endTestCase("MultipleRoom_ElitePackage_Test");
		}
