...
public class Start_A_Project_2_Test extends RunnerTest{
	...
	public void start_a_project2_test() {
		...
		String promoCodeName=ExcelUtilities.getCellData("PromoCodes", AddPromoCode.generateRandomNum(1, 5),0);	
		...
		if(ImageUtils.countBrokenImages("font-size", "14px")==0) {
			...
			//Applying promocode
			BusinessFunctions.setText(paymentInfoPage.txt_promoCode,promoCodeName);
